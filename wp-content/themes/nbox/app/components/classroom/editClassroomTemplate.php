...
<div id="classroom" class="classroom-component animate-visibility" ng-controller="ClassroomController as classroomCtrl" ng-init="classroomCtrl.init(<?php echo get_instructors(); ?>)" ng-show="classroomCtrl.isVisible()">
    ...
    <p>Selecciona una estación disponible</p>
    <span us-spinner spinner-key="change-station-spinner"></span>
    <div class="classroom-container">
        ...
        <ul ng-repeat="rows in classroomCtrl.distribution">
            <li class="station-container" ng-repeat="station in rows" ng-click="classroomCtrl.selectStation(station)" ng-class="[classroomCtrl.getStationClass(station), station.getStyle(), {'my-booked-station':classroomCtrl.isMyStation(station)}]">
                <div class="station" ng-if="station.getStatus() != DEFAULT_VALUES.STATION_STATUS.INACTIVE">
                    ...
                    <span ng-if="classroomCtrl.isMyStation(station)" class="my-station"></span>
                </div>
                <div class="station-description">{{ station.getDescription() }}</div>
            </li>
        </ul>
        <div class="actions">
            <a href="" class="close-link" ng-click="classroomCtrl.closeClassroom()">Regresar a los entrenamientos reservados</a>
        </div>
